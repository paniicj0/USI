...
{
    public class CreateCourseTutor
    {
        CourseController courseController;

        public CreateCourseTutor()
        {
        ...
        {
            Console.WriteLine("Create new tutor: ");
            ...
            Course course = new Course(-1, language, languageLevel, duration, days, start, realization, students, tutorId, 0);
